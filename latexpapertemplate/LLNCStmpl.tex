...
\begin{document}
\title{Parsing Recurring Sequence using LZ78}
...
\author{Harshit Maheshwari\inst{1} \and Satyadev Nandakumar\inst{2}}
...
\institute{Indian Institute of Technology, Kanpur \email{harshitm@cse.iitk.ac.in} \and Indian Institute of Technology, Kanpur
%\thanks{Thank you to...}
